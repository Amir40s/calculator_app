...
class SplashScreen extends StatelessWidget {
  ...
  Widget _buildTopContent(BuildContext context) {
    return Column(
      ...
      children: [
        LogoTextWidget(color: AppColors.whiteColor,),
    ...
    return Column(
      ...
      children: [
        ...
        _buildSocialButton(
          ...
          icon: SvgPicture.asset(AppIcons.mail),
        ...
        Row(
          children: [
            ...
            Padding(
              ...
              child: AppTextWidget(text: 'or continue to',color: AppColors.greyColor,),
            ),
            Expanded(child: Divider()),
          ],
        ),
        SizedBox(height: 4.h),
        // Login Link/Button
        _buildLoginButton(text: 'Login to your account',),
      ],
    );
  }
