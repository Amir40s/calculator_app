        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              AppTextField(
                  hintText: "e.g., 4'6\"", heading: "Thickness (ft'in\")",controller: controller.thicknessController,),
              AppTextWidget(
              ...
              Obx((){
                ...
                if(res == null){
                  return AppTextWidget(
                    ...
                    text: "No results yet. Enter details (e.g., 4'6\", 8'0\", 0'6\", 1:2:4) and click \"Calculate\".",
                  );
                }
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  children: [
                    ...
                    DynamicTable(headers: ['Item','Quantity'], rows: [
                      ['Wet Volume (ft³)', AppUtils().toRoundedDouble(res.results?.wetVolume).toStringAsFixed(0)],
                      ['Dry Volume (ft³)',AppUtils().toRoundedDouble(res.results?.dryVolume).toStringAsFixed(0)],
                      ['Cement Bags',AppUtils().toRoundedDouble(res.results?.cementBags).toStringAsFixed(0)],
                      ['Sand (ft³)',AppUtils().toRoundedDouble(res.results?.sandVol).toStringAsFixed(0)],
                      ['Crush (ft³)',AppUtils().toRoundedDouble(res.results?.crushVol).toStringAsFixed(0)],
                      ['Water (liters)',AppUtils().toRoundedDouble(res.results?.waterLiters).toStringAsFixed(0)],
                    ]),
                    SizedBox(height: 2.h,),
                  ],
                );
