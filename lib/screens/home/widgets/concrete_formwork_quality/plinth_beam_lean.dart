      ...
      body: SingleChildScrollView(
        ...
        child: Obx(() {
            ...
            children: [
              ...
              for (int i = 0; i < controller.beam.length; i++) ...[
                ...
                TwoFieldsWidget(
                  ...
                  hint: "e.g., 4'6\"",
                  hint2: "e.g., 8'0\"",          keyboardType: TextInputType.numberWithOptions(),
          ...
          keyboardType: TextInputType.numberWithOptions(),
                ...
                Row(
                  children: [
                    Expanded(child: AppTextField(hintText: "0",keyboardType: TextInputType.numberWithOptions() ,controller: controller.beam[i]['cement']!)),
                    SizedBox(width: 1.w),
                    Expanded(child: AppTextField(hintText: "0", controller: controller.beam[i]['sand']!,keyboardType: TextInputType.numberWithOptions())),
                    SizedBox(width: 1.w),
                    Expanded(child: AppTextField(hintText: "0", controller: controller.beam[i]['crush']!,keyboardType: TextInputType.numberWithOptions())),
                  ],
                ),
                SizedBox(height: 2.h),
              ],
